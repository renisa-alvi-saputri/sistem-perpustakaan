...
<div class="px-2 py-2">
    ...
    <div class="flex gap-4 mb-6 items-center">
        <button onclick="openModal()"
            class="bg-[#5C7F9C] text-white px-4 py-2 rounded-lg shadow hover:bg-[#4a6d87]">
            + Pengembalian
        </button>
    </div>
    ...
    <div class="bg-white p-6 rounded-xl w-96 shadow-lg">
        ...
        <form method="POST" action="{{ route('pengembalian.store') }}">
            ...
            <div class="mb-4">
                ...
                <select name="peminjaman_id" id="bukuSelect"
            ...
            <div class="flex justify-end gap-2 mt-4">
                <button type="button" onclick="closeModal()"
                    class="bg-gray-400 px-3 py-1 text-white rounded">
                    Batal
                </button>
