                ...
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-gray-50">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="py-2.5 text-gray-400 text-xs">{{ \Carbon\Carbon::parse($m->tgl_pinjam)->format('d M Y') }}</td>
                            <td class="py-2.5">
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-[10px] text-gray-300 mt-0.5">{{ \Carbon\Carbon::parse($a->updated_at)->diffForHumans() }}</p>
                        </div>
                        <span class="flex-shrink-0 text-[10px] px-2 py-0.5 rounded-full
            ...
            <div class="space-y-3">
                ...
                @foreach($statusList as $key => $info)
                    ...
                    <div class="flex items-center gap-3">
                        <span class="w-3 h-3 rounded-full flex-shrink-0" style="background-color: {{ $info['color'] }}"></span>
